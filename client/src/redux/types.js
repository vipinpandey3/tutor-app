...
export const ADD_REMARKS_ERROR = "ADD_REMARKS_ERROR"
...
export const GET_STUDENT_URL = '/api/students/get-students';
export const GET_STUDENT_FORMFIELDS_URL = 'admin/get-student-formFields';
export const ADD_STUDENT_URL = '/api/students/create-student';
export const FETCH_STUDENT_DETAILS_URL = 'admin/studentDetails/'
export const FETCH_STUDENT_FEES_URL = 'admin/getFeesDetailsById/';
export const FETCH_STUDENT_ATTENDENCE_URL = 'api/students/getStudentAllAttendenceById/';
...
export const CREATE_STUDENT_REMARKS_URL = "/api/class/createRemarks"