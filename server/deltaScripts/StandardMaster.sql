...
INSERT INTO StandardMaster(std, stdCode, remarks, createdBy, status, createdAt, updatedAt)values('11', 'XI-Eleventh', 'FYJC', 1, 0, now(), now());
INSERT INTO StandardMaster(std, stdCode, remarks, createdBy, status, createdAt, updatedAt)values('12', 'XII-Twelth', 'SYJC', 1, 0, now(), now());
INSERT INTO StandardMaster(std, stdCode, remarks, createdBy, status, createdAt, updatedAt)values('13', 'XIII-Thirteenth', 'FY', 1, 0, now(), now());
INSERT INTO StandardMaster(std, stdCode, remarks, createdBy, status, createdAt, updatedAt)values('14', 'XIV-Fourteenth', 'SY', 1, 0, now(), now());
INSERT INTO StandardMaster(std, stdCode, remarks, createdBy, status, createdAt, updatedAt)values('15', 'XV-Fifteenth', 'TY', 1, 0, now(), now());
